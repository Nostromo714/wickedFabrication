        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-center md:text-left mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 mt-2 ">
              <li><a href="/services#design" className="text-gray-400 hover:text-white flex justify-center ">Design</a></li>
              <li><a href="/services#fabrication" className="text-gray-400 hover:text-white flex justify-center ">Welding and Fabrication</a></li>
              <li><a href="/services#signs" className="text-gray-400 hover:text-white flex justify-center">Industrial Signs and Art</a></li>
            </ul>
          </div>
