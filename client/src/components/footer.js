        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-center md:text-left mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 mt-2 ">
              <li><a href="services/service1" className="text-gray-400 hover:text-white flex justify-center ">Fabrication</a></li>
              <li><a href="services/service2" className="text-gray-400 hover:text-white flex justify-center ">Welding</a></li>
              <li><a href="services/service3" className="text-gray-400 hover:text-white flex justify-center ">Design</a></li>
            </ul>
          </div>
