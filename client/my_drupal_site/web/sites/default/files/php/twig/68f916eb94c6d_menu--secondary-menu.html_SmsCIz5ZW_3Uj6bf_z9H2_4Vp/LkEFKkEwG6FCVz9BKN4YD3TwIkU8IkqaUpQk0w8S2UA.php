...
$context["item"], "below", [], "any", false, false, true, 64)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("secondary-nav__menu-link--has-children") : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/olivero/templates/navigation/menu--secondary-menu.html.twig", "/Users/lucydoray/wickedFabrication/client/my_drupal_site/web/core/themes/olivero/templates/navigation/menu--secondary-menu.html.twig");
    }
